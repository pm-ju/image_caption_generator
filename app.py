...
async def get_stylized_caption(base_caption, style):
    ...
    style_prompts = {
        "Humorous": f"Rewrite the following image caption to be funny and witty: '{base_caption}'",
        "Poetic": f"Rewrite the following image caption as a short, elegant two-line poem: '{base_caption}'",
        "Dramatic": f"Rewrite the following image caption with a dramatic and epic tone: '{base_caption}'",
        "Philosophical": f"Take this simple image description, '{base_caption}', and rewrite it as a short, thought-provoking philosophical reflection.",
        "Historical Context": f"Based on the image description '{base_caption}', invent a plausible and interesting historical context or backstory for the scene. Write it as a short, engaging narrative."
    }
